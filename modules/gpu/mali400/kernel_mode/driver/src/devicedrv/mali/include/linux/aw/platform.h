...
#ifdef CONFIG_ARCH_SUN5I
extern void sun5i_get_fb_addr_para(struct __fb_addr_para *fb_addr_para);
#else /* CONFIG_ARCH_SUN5I */
...
typedef struct {
	...
	aw_clk_data clk[3];
#else /* CONFIG_ARCH_SUN5I || CONFIG_ARCH_SUN7I */
	aw_clk_data clk[2];
#endif /* CONFIG_ARCH_SUN5I || CONFIG_ARCH_SUN7I */
