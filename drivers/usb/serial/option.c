...
#define EXAR_VENDOR_ID                         0x04E2
#define EXAR_PRODUCT_1414                      0x1414
...
//	{USB_DEVICE(0x12d1, 0x1d09)},
	{ USB_DEVICE_AND_INTERFACE_INFO(EXAR_VENDOR_ID, EXAR_PRODUCT_1414, 0xff, 0xff, 0xff) },
			...
			const struct usb_device_id *id)
{
	...
	if (dev_desc->idVendor == cpu_to_le16(SAMSUNG_VENDOR_ID) &&
        ...
        if(dev_desc->idVendor == 0x05C6 && dev_desc->idProduct == 0x9003 && iface_desc->bInterfaceNumber >= 4)
                return -ENODEV;
        //Quectel EC20's interface 4 can be used as USB Network device
        if(dev_desc->idVendor == 0x05C6 && dev_desc->idProduct == 0x9215 && iface_desc->bInterfaceNumber >= 4)
                return -ENODEV;
        //Quectel EC21&EC25&EC20 R2.0's interface 4 can be used as USB Network device
        if(dev_desc->idVendor == 0x2C7C && iface_desc->bInterfaceNumber >= 4)
                return -ENODEV;
