...
#define TOUCH_PANEL_MAX_X       (touch_panel_max_x)
#define TOUCH_PANEL_MAX_Y       (touch_panel_max_y)

#define PRESS_MAX		(255)
static int screen_max_x=1;
static int screen_max_y=1;
static int touch_panel_max_x=1;
static int touch_panel_max_y=1;
static int revert_x_flag=0;
static int revert_y_flag=0;
static int exchange_x_y_flag=0;
static __u32 twi_id=0;
static char irq_pin_name[8]={0x0};
...
void ctp_print_info(struct ctp_config_info info,int debug_level)
{
	if(debug_level == DEBUG_INIT) {
		...
		dprintk(DEBUG_INIT,"info.screen_max_y:%d\n",info.screen_max_y);
                dprintk(DEBUG_INIT,"info.touch_panel_max_x:%d\n",info.touch_panel_max_x);
                dprintk(DEBUG_INIT,"info.touch_panel_max_y:%d\n",info.touch_panel_max_y);
...
static void gtp_touch_down(struct goodix_ts_data* ts,s32 id,s32 x,s32 y,s32 w)
{
        ...
        x=x*SCREEN_MAX_X/TOUCH_PANEL_MAX_X;//bluesky
        y=y*SCREEN_MAX_Y/TOUCH_PANEL_MAX_Y;//bluesky
...
static int ctp_get_system_config(void)
{
        ...
        touch_panel_max_x = config_info.touch_panel_max_x;
        touch_panel_max_y = config_info.touch_panel_max_y;
