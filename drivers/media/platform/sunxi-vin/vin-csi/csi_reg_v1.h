...
#ifndef __CSI__REG__V1__H__
#define __CSI__REG__V1__H__
...
enum csi_output_fmt {
	...
	CSI_FIELD_PLANAR_YUV422 = 0,	/* parse a field(odd or even)
					 * into planar yuv420
					 */
	CSI_FIELD_PLANAR_YUV420 = 1,	/* parse a field(odd or even)
					 * into planar yuv420
					 */
	CSI_FRAME_PLANAR_YUV420 = 2,
	CSI_FRAME_PLANAR_YUV422 = 3,
	CSI_FIELD_UV_CB_YUV422 = 4,	/* parse and reconstruct evry
					 * 2 fields(odd and even) into a frame,
					 * format is planar yuv420
					 */
	...
	CSI_FIELD_PLANAR_YUV444 = 0,	/* parse a field(odd or even)
					 * into planar yuv444
					 */
	CSI_FIELD_UV_CB_YUV444_YUV422 = 1,	/* parse a field(odd or even)
						 * into planar yuv422
						 */
...
struct csi_timing_cfg {
	...
	enum csi_edge_pol sample;	/* valid of the input clock edge type */
};
...
struct csi_cfg {
	...
	enum csi_ref_pol vref;	/* input vref signal polarity */
	enum csi_ref_pol href;	/* input href signal polarity */
	enum csi_edge_pol clock;	/* valid of the input clock edge type */
};
