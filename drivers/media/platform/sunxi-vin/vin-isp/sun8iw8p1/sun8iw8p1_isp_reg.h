 ...
 * sun8iw8p1_isp_reg.h
 *
 * Hawkview ISP - sun8iw8p1_isp_reg.h module
 *
...
/* FOR SUN8IW8P1 ISP */
#define SUN8IW8P1_ISP_FE_CFG_REG_OFF                  ISP_FE_CFG_REG_OFF
#define SUN8IW8P1_ISP_FE_CTRL_REG_OFF                 ISP_FE_CTRL_REG_OFF
#define SUN8IW8P1_ISP_FE_INT_EN_REG_OFF               ISP_FE_INT_EN_REG_OFF
#define SUN8IW8P1_ISP_FE_INT_STA_REG_OFF              ISP_FE_INT_STA_REG_OFF

#define SUN8IW8P1_ISP_LINE_INT_NUM_REG_OFF            0x018
#define SUN8IW8P1_ISP_ROT_OF_CFG_REG_OFF              0x01c

#define SUN8IW8P1_ISP_REG_LOAD_ADDR_REG_OFF           ISP_REG_LOAD_ADDR_REG_OFF
#define SUN8IW8P1_ISP_REG_SAVED_ADDR_REG_OFF          ISP_REG_SAVED_ADDR_REG_OFF

#define SUN8IW8P1_ISP_LINEAR_LENS_GAMMA_ADDR_REG_OFF	0x028
#define SUN8IW8P1_ISP_DRC_DISC_ADDR_REG_OFF		0x02c

#define SUN8IW8P1_ISP_STATISTICS_ADDR_REG_OFF         ISP_STATISTICS_ADDR_REG_OFF
#define SUN8IW8P1_ISP_SRAM_RW_OFFSET_REG_OFF          ISP_SRAM_RW_OFFSET_REG_OFF
#define SUN8IW8P1_ISP_SRAM_RW_DATA_REG_OFF            ISP_SRAM_RW_DATA_REG_OFF
...
} SUN8IW8P1_ISP_FE_INT_STA_REG_t;
...
} SUN8IW3P1_SUN8IW8P1_ISP_LINE_INT_NUM_REG_t;
...
} SUN8IW3P1_SUN8IW8P1_ISP_ROT_OF_CFG_REG_t;
...
} SUN8IW8P1_ISP_REG_LOAD_ADDR_REG_t;
...
} SUN8IW8P1_ISP_REG_SAVED_ADDR_REG_t;
...
} SUN8IW8P1_ISP_LUT_LENS_GAMMA_ADDR_REG_t;
...
} SUN8IW8P1_ISP_STATISTICS_ADDR_REG_t;
...
} SUN8IW8P1_ISP_SRAM_RW_OFFSET_REG_t;
...
} SUN8IW8P1_ISP_SRAM_RW_DATA_REG_t;
