...
#define DEV_DBG_EN      0
#if (DEV_DBG_EN == 1)
#define sensor_dbg(x, arg...) printk("[OV5640]"x, ##arg)
#else
#define sensor_dbg(x, arg...)
#endif
#define sensor_err(x, arg...) printk("[OV5640]"x, ##arg)
#define sensor_print(x, arg...) printk("[OV5640]"x, ##arg)

#define CAP_BDG 0
#if (CAP_BDG == 1)
#define sensor_cap_dbg(x, arg...) printk("[OV5640_CAP_DBG]"x, ##arg)
#else
#define sensor_cap_dbg(x, arg...)
#endif
...
static int sensor_reg_init(struct sensor_info *info)
{
	...
	if (info->capture_mode == V4L2_MODE_VIDEO) {
		...
		if (info->flash_mode != V4L2_FLASH_LED_MODE_NONE) {
			if (to_flash == 1) {
				sensor_cap_dbg("open flash when capture\n");
