...
MODULE_DESCRIPTION("A low-level driver for OV2710_AW6131  sensors");
MODULE_LICENSE("GPL");

/*for internel driver debug*/
#define DEV_DBG_EN      (0xFF)
#ifdef DEV_DBG_EN
#define vfe_dev_dbg(x, arg...)	printk("[OV2710_AW6131]"x,	##arg)
#else
#define vfe_dev_dbg(x, arg...)
#endif
#define vfe_dev_err(x, arg...)	printk("[OV2710_AW6131]"x,	##arg)
#define vfe_dev_print(x, arg...)	printk("[OV2710_AW6131 ]"x,	##arg)
...
static struct regval_list sensor_default_regs[] = {
	...
	{0xfffd, 0x80},
	{0xfffe, 0x14},
	{0x1c00, 0x4b},		/*add three register for mirror & flip */
