...
int vfe_open_special(int tvd_fd);
int vfe_close_special(int tvd_fd);
...
int dqbuffer_special(int tvd_fd, struct vfe_buffer **buf);
int qbuffer_special(int tvd_fd, struct vfe_buffer *buf);
...
void virtual_vfe_register_buffer_done_callback(void *func);
#endif
